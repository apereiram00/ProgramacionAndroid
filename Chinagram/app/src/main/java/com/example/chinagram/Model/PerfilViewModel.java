...
public class PerfilViewModel extends AndroidViewModel {
    ...
    public void updateFollowers(String userId, int newFollowers, UsuarioRepositorio.UpdateCallback updateCallback) {
        usuarioRepositorio.updateFollowers(userId, newFollowers, updateCallback);
    }

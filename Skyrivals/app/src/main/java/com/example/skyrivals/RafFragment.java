...
import com.example.skyrivals.databinding.FragmentRafBinding;

import java.util.List;

public class RafFragment extends Fragment {

    private FragmentRafBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentRafBinding.inflate(inflater, container, false);
    ...
    private void setupRecyclerView() {
        ...
        avionViewModel.getAvionesRaf().observe(getViewLifecycleOwner(), new Observer<List<Avion>>() {
            @Override

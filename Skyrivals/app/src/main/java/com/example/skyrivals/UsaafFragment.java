...
import com.example.skyrivals.databinding.FragmentUsaafBinding;

import java.util.List;

public class UsaafFragment extends Fragment {

    private FragmentUsaafBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentUsaafBinding.inflate(inflater, container, false);
    ...
    private void setupRecyclerView() {
        ...
        avionViewModel.getAvionesUsaaf().observe(getViewLifecycleOwner(), new Observer<List<Avion>>() {
            @Override

...
import com.example.skyrivals.databinding.FragmentLuftwaffeBinding;

import java.util.List;

public class LuftwaffeFragment extends Fragment {

    private FragmentLuftwaffeBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentLuftwaffeBinding.inflate(inflater, container, false);
    ...
    private void setupRecyclerView() {
        ...
        avionViewModel.getAvionesLuftwaffe().observe(getViewLifecycleOwner(), new Observer<List<Avion>>() {
            @Override
